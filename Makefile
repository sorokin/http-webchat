#############################################################################
# Makefile for building: Http-ProxyServer
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  Http-ProxyServer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Http-ProxyServer.pro
#############################################################################
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Http-ProxyServer.pro application.h \
		...
		TCP-socket/tcpserversocket.h main.cpp \
		application.cpp \
		ChatServer/chatserver.cpp \
		Http/httpclient.cpp \
		Http/httpobject.cpp \
...
Makefile: Http-ProxyServer.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		Http-ProxyServer.pro \
		/usr/lib/libQt5Core.prl
	$(QMAKE) -o Makefile Http-ProxyServer.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents application.h ChatServer/chatserver.h Http/httpclient.h Http/httpobject.h Http/httprequest.h Http/httpresponse.h Http/httpserver.h Http/httputils.h Http/routematcher.h TCP-socket/tcpsocket.h TCP-socket/tcpserversocket.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp application.cpp ChatServer/chatserver.cpp Http/httpclient.cpp Http/httpobject.cpp Http/httprequest.cpp Http/httpresponse.cpp Http/httpserver.cpp Http/httputils.cpp Http/routematcher.cpp TCP-socket/tcpsocket.cpp TCP-socket/tcpserversocket.cpp $(DISTDIR)/
...
chatserver.o: ChatServer/chatserver.cpp ChatServer/chatserver.h \
		...
		Http/httputils.h \
		Http/routematcher.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chatserver.o ChatServer/chatserver.cpp

httpclient.o: Http/httpclient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o httpclient.o Http/httpclient.cpp

httpobject.o: Http/httpobject.cpp Http/httpobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o httpobject.o Http/httpobject.cpp
...
routematcher.o: Http/routematcher.cpp Http/routematcher.h \
		Http/httprequest.h \
		Http/httpobject.h \
		Http/httputils.h \
		TCP-socket/tcpsocket.h \
